...
<div class="container-fluid">
    ...
    <div class="page-title-wrap">
        <div>
            ...
            <p class="page-subtitle">
                Rekap transaksi <strong>barang keluar</strong> ke berbagai unit tujuan berdasarkan periode dan filter yang dipilih.
            </p>
        </div>
        <div></div>
    </div>
    ...
    <div class="panel-card">
        ...
        <p class="panel-subtitle mb-3">
            Sesuaikan periode dan unit tujuan untuk melihat distribusi barang keluar yang lebih spesifik.
        </p>
                ...
                <div class="filter-group">
                    ...
                    <div class="filter-actions">
                        ...
                        @if($dateFrom || $dateTo || $unitId)
                            <button type="button"
                                    onclick="window.location='{{ route('reports.outgoing') }}'"
    ...
    <div class="panel-card">
        <div class="d-flex justify-content-between mb-2">
            <div>
                <h6 class="panel-title mb-0">Data Barang Keluar</h6>
                <p class="panel-subtitle mb-0">
                    Menampilkan daftar transaksi barang keluar sesuai dengan filter yang diterapkan.
                </p>
            </div>
            ...
            <table class="table table-requests align-middle mb-0">
                <thead>
                    <tr class="text-nowrap">
                        ...
                        <th style="width:160px;">Unit Tujuan</th>
                        <th>Keterangan</th>
                    </tr>
                </thead>
                <tbody>
                @forelse($rows as $i => $t)
                    ...
                    <tr>
                        ...
                        <td class="meta-small">{{ $unitR->unit_name ?? '-' }}</td>
