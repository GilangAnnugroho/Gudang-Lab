...
<div class="container-fluid">
    ...
    <div class="page-title-wrap">
        <div>
            ...
            <p class="page-subtitle">
                Tambahkan kategori baru untuk mengelompokkan item di gudang Labkesda.
            </p>
        </div>
    </div>
    ...
    <div class="panel-card">
        <form method="post" action="{{ route('categories.store') }}">
            ...
            {{-- VALIDATION MESSAGE (optional, bukan flash sukses) --}}
            @if ($errors->any())
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <textarea
                        ...
                        placeholder="Contoh: Bahan kimia habis pakai untuk pemeriksaan lab.">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-stretch align-items-md-center mt-4 gap-2">
                ...
                <button type="submit" class="btn btn-primary-gradient">
                    <i class="ri-save-3-line me-1"></i> Simpan Kategori
                </button>
            </div>
        </form>
    </div>
