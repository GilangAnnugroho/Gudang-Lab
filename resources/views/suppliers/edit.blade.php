@extends('layouts.app')
@section('title','Edit Rekanan: '.$supplier->supplier_name)
...
<div class="container-fluid">
    ...
    <div class="page-title-wrap">
        <div>
            <h1 class="page-title">Edit Rekanan</h1>
            <p class="page-subtitle mb-0">
                Perbarui data rekanan
    ...
    <div class="panel-card">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <span class="badge bg-light text-muted border" style="border-radius:999px;">
                Rekanan:
                <span class="fw-semibold ms-1">{{ $supplier->supplier_name }}</span>
                @if($supplier->phone)
                    <span class="ms-2">•</span>
                    <span class="ms-1">Telp: {{ $supplier->phone }}</span>
                @endif
            </span>
        </div>
        ...
        <form method="post" action="{{ route('suppliers.update', $supplier) }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="email"
                           ...
                           value="{{ old('email', $supplier->email ?? null) }}"
                ...
                <div class="col-md-12">
                    ...
                    <textarea
                        ...
                        placeholder="Alamat lengkap kantor / gudang rekanan">{{ old('address', $supplier->address) }}</textarea>
                    @error('address')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-stretch align-items-md-center mt-4 gap-2">
                ...
                <button type="submit" class="btn btn-primary-gradient">
                    <i class="ri-save-3-line me-1"></i> Update Rekanan
                </button>
            </div>
