@extends('layouts.app')
@section('title','Tambah Item Master')
...
<div class="container-fluid">
    ...
    <div class="page-title-wrap">
        <div>
            <h1 class="page-title">Tambah Item Master</h1>
            <p class="page-subtitle">
                Registrasi item baru ke dalam database gudang Labkesda.
            </p>
        </div>
    </div>
        ...
        <form action="{{ route('items.store') }}" method="post">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4 col-lg-3">
                    ...
                    <select name="base_unit"
                        ...
                        @foreach($baseUnits as $label)
                            <option value="{{ $label }}" {{ old('base_unit') === $label ? 'selected' : '' }}>
                                {{ $label }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6 col-lg-8">
                    ...
                    <textarea
                        ...
                        placeholder="misal: Bahan berbahaya, gunakan APD; jangan dibekukan; hanya untuk pemeriksaan in-vitro">{{ old('warnings') }}</textarea>
                    @error('warnings')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-stretch align-items-md-center mt-4 gap-2">
                ...
                <button type="submit" class="btn btn-primary-gradient">
                    <i class="ri-save-3-line me-1"></i> Simpan Item
                </button>
            </div>
        </form>
    </div>
